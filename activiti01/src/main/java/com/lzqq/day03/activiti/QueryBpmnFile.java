 ...
 *  2.将两个资源文件保存到路径 :  E:\Saas111\备份\资料
 *
 *  技术方案：
 *      1.第一种方式使用activiti的api实现
 *      2.第二种方式,其实就是原理层面,可以使用jdbc的对clob类型,clob类型数据的读取,并保存
 *      3.IO流转换,最好commons-io.jar包可以轻松解决IO操作
 *
 *  真实场景应用: 用户想查看这个请假流程具体有哪些步骤要走？
 *
 */
public class QueryBpmnFile {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //4.设置查询条件
        processDefinitionQuery.processDefinitionKey("myProcess_1");//参数是流程定义的key
        //5.执行查询操作，查询出想要的流程定义
        ...
        //8.构造出OutputStream流
        OutputStream pngOs = new FileOutputStream("E:\\Saas111\\备份\\资料\\"+processDefinition.getDiagramResourceName());
        OutputStream bpmnOs = new FileOutputStream("E:\\Saas111\\备份\\资料\\"+processDefinition.getResourceName());
