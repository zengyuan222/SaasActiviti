...
public class GroupTest {
    ...
    public static void main(String[] args) {
        ...
        //5.判断是否有这个任务
        if(task!=null){
            taskService.setAssignee(task.getId(),"lisi");//交接任务为lishi
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        Task task = taskService.createTaskQuery()
                .processDefinitionKey(key)
                .taskCandidateUser(candidate_users)//设置候选人
                .singleResult();
        //5.输出
        if(task!=null){
    ...
    public static void main(String[] args) {
        ...
        for(Task task : list){
            ...
            System.out.println(task.getId());
            System.out.println(task.getName());
            System.out.println(task.getAssignee());//为null说明当前的zhangsan只是一个候选人，并不是任务的执行人
        }
